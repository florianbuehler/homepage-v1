  ...
  return (
    <Section id="about" className={classes.container}>
      ...
      <p>
        ...
        My tasks have been including requirement gathering, solution design, coordination with business owners,
        implementation, testing and documentation.
      </p>
      <p>
        Since March 2017 I am working as a consultant and later as a senior consultant for d-fine. D-fine is a leading
        European consulting firm with scientifically mindend employees, which provides innovative, customized and
        futureproof software solutions for complex challenges for it&apos;s clients.
      </p>
